    ...
    <div data-slot="month-view" className="contents">
      <div className="grid grid-cols-7 bg-gray-50/50">
        {weekdays.map((day) => (
          <div
            key={day}
            className="text-muted-foreground/70 py-3 text-center text-sm font-medium"
          >
            {day}
          </div>
        ))}
            ...
            {week.map((day, dayIndex) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="group-data-today:bg-myBlue group-data-today:text-white group-data-today:font-semibold mt-1 inline-flex size-7 items-center justify-center rounded-full text-sm transition-colors">
                      {format(day, "d")}
                    </div>
                    <div
